...
Page({
  ...
  finashAction: function () {
    ...
    var urlStr = app.globalData.url + 'messenger/modifyEmail';
    wx.request({
      method: "POST",
      url: urlStr, //仅为示例，并非真实的接口地址
      data: {
  ...
  onLoad: function (options) {
    var that = this;
    if (app.globalData.myInfo.messenger_imformation.email == '' || app.globalData.myInfo.messenger_imformation.email == null){
      this.setData({
        email: '暂无',
        numShow: '',
        psdShow: 'none',
      ...
      this.setData({
        email: app.globalData.myInfo.messenger_imformation.email,
        numShow: '',
        psdShow: 'none',
        modelInnerHtml: '',
        modalHidden: true
