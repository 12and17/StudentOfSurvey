...
Page({
  ...
  fetchSearchList: function () {
    ...
    //访问网络
    util.getProblem(problemType, searchPageNum, callbackcount, searchKeyword, 'unprocess', teacherAccount, function (data) {
      console.log(data)
      //判断是否有数据，有则取数据
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        if (res.data.success == true) {
          ...
          app.globalData.myInfo.count_num.noprocessNum = app.globalData.myInfo.count_num.noprocessNum - 1;
  ...
  onLoad: function () {
    ...
    that.data.teacherAccount = app.globalData.myInfo.process_teacher_imformation.processTeacherAccount;
    that.fetchSearchList();
    that.setData({
      searchLoading: false,
