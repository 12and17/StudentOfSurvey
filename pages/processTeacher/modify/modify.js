...
Page({
  ...
  loginAction: function () {
    var password3 = app.globalData.myInfo.process_teacher_imformation.processTeacherPassword;
    ...
    var urlStr = app.globalData.url + 'processTeacher/modifyPassword';
    wx.request({
      method: "POST",
      url: urlStr, //仅为示例，并非真实的接口地址
      data: {
        processTeacherAccount: app.globalData.myInfo.process_teacher_imformation.processTeacherAccount,
        password: passwords1
      },
      header: {
