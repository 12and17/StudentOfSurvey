...
Page({
  ...
  loginAction: function () {
    var password3 = app.globalData.myInfo.leader_imformation.leaderPassword;
    ...
    var urlStr = app.globalData.url + 'leader/modify';
    wx.request({
      method: "POST",
      url: urlStr, //仅为示例，并非真实的接口地址
      data: {
        leaderAccount: app.globalData.myInfo.leader_imformation.leaderAccount,
        password: passwords1
      },
      header: {
