...
Page({
  ...
  loginAction: function () {
    var password3 = app.globalData.myInfo.messenger_imformation.messPassword;
    ...
    var urlStr = app.globalData.url + 'messenger/modify';
    wx.request({
      method: "POST",
      url: urlStr, //仅为示例，并非真实的接口地址
      data: {
        messengerAccount: app.globalData.myInfo.messenger_imformation.messAccount,
        password: passwords1
      },
      header: {
